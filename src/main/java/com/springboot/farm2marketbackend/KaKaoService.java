package com.springboot.farm2marketbackend;
...
//https://developers.kakao.com/docs/latest/ko/kakaologin/rest-api#request-code-prompt-select-account
//카카오계정 간편 로그인을 사용하려면 prompt 파라미터의 값을 select_account로 지정해 카카오 로그인을 요청해야함
